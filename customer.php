		...
		<div class="row">
						...
						<tr>
							...
							<td>
								<div class='btn-group' role='group'>
								  <button type='button' class='btn btn-default' id='custDelete' cust_id='1'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></button>
								  <button type='button' class='btn btn-default' id='custEdit' cust_id='1' cust_name='customer01' cust_email='customer01@gmail.com' cust_discount='25'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></button>
								</div>
							</td>
						</tr>
					</tbody>
			...
			<div class="col-md-2" style="text-align: right;">
				<nav aria-label="Page navigation">
				  <ul class="pagination" id='cust_page'>
